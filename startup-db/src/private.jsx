...
const [person, setPsn] = React.useState(localStorage.getItem('userName') || 'Username');
  ...
  <Route path='/' element={<Nscr person={person} clkDef={(person)=>{setPsn('Username');localStorage.removeItem('userName');}} clkGen={(person, svp)=>{setPsn(svp);}} />} exact />
