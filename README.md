...
- [x] **Hooks** - I have a hook to make a variable and set it. I used hooks to set the picture variables for being diayed in the main screen, the playing screen, and the error screen.
