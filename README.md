...
- [x] **Stores credentials in MongoDB** - I have the database store people's usernames and the hashes of their passwords. People can make accounts by typing in the keypads I made; these show the username and hide passwords, and they can get into their accounts that they have made, with the same keypads.
