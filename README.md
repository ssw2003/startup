...
- [x] **Hooks** - I have a hook to make a variable and set it. I can use the hooks to set things for display in the main screen, the playing screen, and the error screen.
