...
- [x] **Bundled using Vite** - I am uing Vite to put the code together in Amazon Web Services.
- [x] **Components** - I have navigation bars that navigate to both pages of my website using function calls.
