...
- [x] **Hooks** - I have a hook to make a variable and set it. I used hooks to set the picture variables for being displayed in th main screen, the playing screen, and the error screen.
