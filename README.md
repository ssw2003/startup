...
- [x] **Supports registration, login, logout, and restricted endpoint** - Users casn log in and register. The list of users can be cleared but only by a particular user.
